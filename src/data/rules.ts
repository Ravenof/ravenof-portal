  ...
  // ─── 6. KORTŲ TIPAI ─────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      },
      {
        ...
        calloutVariant: 'quick',
        label: 'Reakcija',
        text: 'Reakcija yra užversta korta, kuri aktyvuojasi tada, kai išsipildo jos sąlyga. Reakciją galima padėti tik savo pagrindinės fazės metu, sumokėjus aukso kainą. Ji lieka užversta su kainos žetonu viršuje (rodo kainą — priešininkas mato, kiek kainavo, bet nežino efekto). Kai sąlyga išsipildoma, reakcija atverčiama, efektas išsprendžiamas, korta keliauja į panaudotų kortų krūvą. Reakcija gali aktyvuotis tiek žaidėjo, tiek priešininko ėjimo metu. Jei vienu metu gali aktyvuotis kelios reakcijos — pirmiausia sprendžiama ta, kuri aktyvavosi paskutinė.',
      },
      {
        type: 'callout',
        calloutVariant: 'quick',
  ...
  // ─── 12. KOVOS IR ŽALOS TAISYKLĖS ───────────────────────────────────────
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: 'Magiškojo skydo atveju žala blokuojama — ŽMK korta netraukiama. Po blokavimo Magiškasis skydas pašalinamas. Puolantysis vis tiek gauna atgalinę žalą (su savo ŽMK korta).',
      },
    ],
  },

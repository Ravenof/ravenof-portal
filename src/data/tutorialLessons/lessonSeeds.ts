  ...
  config: {
    ...
    setup: {
      ...
      player: { gold: 100, hand: ['Piratas žvalgas', 'Ida', 'Hokieg’as'],
                deck: ['Gisela', 'Ida', 'Piratas žvalgas', 'Hokieg’as', 'Gisela'] },
...
const L2_STEPS: LessonStep[] = [
  ...
  { id: 'trade-math',
    ...
    highlight: [{ kind: 'unit', side: 'you', cardName: 'Gisela' }, { kind: 'unit', side: 'ai', cardName: 'Zombis klajoklis' }],
    zoom: { kind: 'unit', side: 'you', cardName: 'Gisela' }, complete: { on: 'next' } },
  { id: 'trade-do', objective: 'Atlik mainus',
    dialogue: [say('l2-s06', 'Pulk. Pajusk mainus savo kailiu.')],
    highlight: [{ kind: 'unit', side: 'you', cardName: 'Gisela' }, { kind: 'unit', side: 'ai', cardName: 'Zombis klajoklis' }],
    arrowFrom: { kind: 'unit', side: 'you', cardName: 'Gisela' }, arrowTo: { kind: 'unit', side: 'ai', cardName: 'Zombis klajoklis' }, arrowStyle: 'drag-path',
...
const level2: LessonSeed = {
  ...
  config: {
    ...
    setup: {
      disableZmk: true,
      player: { gold: 300, board: ['Ida', 'Gisela', 'Hokieg’as'],
                hand: ['Piratas žvalgas'], deck: ['Ida', 'Gisela', 'Piratas žvalgas', 'Hokieg’as'] },
...
const L3_STEPS: LessonStep[] = [
  ...
  { id: 'aoe', objective: 'Paleisk audrą (AOE)',
    ...
    highlight: [{ kind: 'handCard', cardName: 'Tornadas' }, { kind: 'anchor', anchor: 'units-ai' }],
    arrowFrom: { kind: 'handCard', cardName: 'Tornadas' }, arrowTo: { kind: 'anchor', anchor: 'units-ai' }, arrowStyle: 'drag-path',
    allow: [{ kind: 'play-spell', cardName: 'Tornadas' }],
    complete: { on: 'event', eventType: 'spell', side: 'you', cardName: 'Tornadas' } },
  { id: 'aoe-note',
  ...
  { id: 'trap-springs',
    ...
    // puolėjo. Priešas jį SUŽAIDŽIA savo ėjimu (matomas iškvietimas), o puola kitu
    // taktu — kad reakcija aiškiai suveiktų būtent per ataką, ne „iškvietimo metu".
    enemyScript: [{ type: 'play', cardName: 'Hikage' }, { type: 'attack', attackerCard: 'Hikage', targetCard: 'Ida' }, { type: 'endTurn' }],
    complete: { on: 'enemyTurnDone' } },
  { id: 'trap-explain',
...
const level3: LessonSeed = {
  ...
  config: {
    ...
    setup: {
      disableZmk: true,
      player: { gold: 900, board: ['Ida', 'Gisela'],
                hand: ['Stingdantis kristalas', 'Tornadas', 'Paslėpta galia', 'Šviesos palaiminimas'],
...
const level4: LessonSeed = {
  ...
  config: {
    ...
    setup: {
      disableZmk: true,
      player: { gold: 1000, board: ['Gisela', 'Hokieg’as'],
                hand: ['Archimagas Lisarijus|1', 'Piratas žvalgas', 'Ida', 'Archimagas Lisarijus|2', 'Piratas žvalgas', 'Hokieg’as'],
                deck: ['Ida', 'Gisela', 'Piratas žvalgas'] },
      // Priešas čia ne manekenas: turi ranką/kaladę ir laisvoje kovoje („finish") žaidžia DI.
      enemy: { hp: 16, board: ['Hikage'], hand: ['Goblinas žvalgas', 'Hikage'],
               deck: ['Zombis klajoklis', 'Naotsuo', 'Hikage', 'Goblinas žvalgas', 'Zombis klajoklis'] },
    },
    enemyAi: 'easy',
    steps: L4_STEPS,
  },
...
const level5: LessonSeed = {
  ...
  config: {
    ...
    setup: {
      disableZmk: true,
      player: { gold: 1000, board: ['Ida', 'Gisela', 'Riteris'],
...
const L6_STEPS: LessonStep[] = [
  ...
  { id: 'freeze-attack', objective: 'Pulk užšaldytą — be atsako',
    ...
    highlight: [{ kind: 'unit', side: 'you', cardName: 'Gisela' }, { kind: 'unit', side: 'ai', cardName: 'Wrosxa' }],
    arrowFrom: { kind: 'unit', side: 'you', cardName: 'Gisela' }, arrowTo: { kind: 'unit', side: 'ai', cardName: 'Wrosxa' }, arrowStyle: 'drag-path',
  ...
  { id: 'burn', objective: 'Padek',
    ...
    arrowFrom: { kind: 'handCard', cardName: 'Liepsnos antspaudas' }, arrowTo: { kind: 'unit', side: 'ai', cardName: 'Wrosxa' }, arrowStyle: 'drag-path',
  ...
  { id: 'shield-stealth', objective: 'Skydas ir sėlinimas',
    // Lenta valoma (demonstracijų karuselė – 5 slotai greitai prisipildo padarais su Kovos šūksniu).
    apply: { clearBoardYou: true, addBoardYou: ['Gisela', 'Ordino pėstininkas', 'Toguchi'] },
  ...
  { id: 'blessed', objective: 'Palaiminimas: kitas smūgis su pranašumu',
    ...
    apply: { enableZmk: true, goldYou: 1000, clearBoardYou: true, addBoardYou: ['Gisela', 'Ida'], addBoardAi: ['Zombis klajoklis'],
...
const level6: LessonSeed = {
  ...
  config: {
    ...
    setup: {
      disableZmk: true,
      player: { gold: 1000, board: ['Gisela'],
                hand: ['Ledo spindulys', 'Takumi', 'Matriarchė Gorta', 'Liepsnos antspaudas', 'Nakties tarnas'],
  ...
  config: {
    ...
    setup: {
      ...
      player: { gold: 600, board: ['Ida'],
                ...
                deck: ['Piratas žvalgas', 'Gisela', 'Hokieg’as'],
...
const L8_STEPS: LessonStep[] = [
  ...
  { id: 'mulligan', objective: 'Pakeisk brangias pradines kortas',
    ...
    highlight: [{ kind: 'handCard', cardName: 'Tornadas' }],
    arrowTo: { kind: 'handCard', cardName: 'Tornadas' }, arrowStyle: 'pulse',
    zoom: { kind: 'handCard', cardName: 'Tornadas' },
    allow: [{ kind: 'mulligan' }],
...
const level8: LessonSeed = {
  ...
  config: {
    ...
    setup: {
      disableZmk: true,
      player: { hand: ['Piratas žvalgas', 'Tornadas', 'Ida', 'Užnugario ataka', 'Hokieg’as'],
                deck: ['Gisela', 'Piratas žvalgas', 'Ida'] },
      enemy: { hp: 30, board: ['Hikage'], deck: ['Goblinas žvalgas', 'Hikage', 'Zombis klajoklis'] },
    },
    steps: L8_STEPS,
  },

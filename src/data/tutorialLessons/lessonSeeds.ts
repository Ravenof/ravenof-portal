...
const L1_STEPS: LessonStep[] = [
  ...
  { id: 'card-atk',
    dialogue: [say('l1-s10', 'Kardas — atakos jėga.', 'Kardas — atakos jėga. Tiek žalos ji kirs priešui.')],
...
const L2_STEPS: LessonStep[] = [
  ...
  { id: 'clean-kill',
    dialogue: [say('l2-s03', 'Švarus kirtis — priešas žuvo nespėjęs atsakyti.',
      'Švarus kirtis. Priešas žuvo nespėjęs atsakyti — nes tavo smūgis jį pribaigė.')],
    complete: { on: 'next' } },
  { id: 'retaliation-rule', objective: 'Suprask mainus',
    dialogue: [say('l2-s04', 'Kai puoli GYVĄ padarą — jis kerta atgal. Kiekviena ataka yra mainai.',
      'Bet dabar klausyk atidžiai, nes čia žūsta naujokai. Kai puoli gyvą padarą — jis kerta atgal. Tu gauni jo atakos žalą. Kiekviena ataka yra mainai.')],
...
const L4_STEPS: LessonStep[] = [
  { id: 'intro', objective: 'Pašauk čempioną',
    ...
    complete: { on: 'next' } },
  { id: 'tribute-rule',
    dialogue: [say('l4-s02', 'Čempionas reikalauja AUKOS: dvi kortos iš rankos. Suabejojęs — spausk „Atšaukti".',
      'Čempionas — ne eilinis karys. Jis reikalauja aukos: dvi kortos iš rankos mainais už jo atėjimą. Rinkis atsargiai... arba atšauk, jei suabejosi — mygtukas apačioje.')],
  ...
  { id: 'summon-champ', objective: 'Paaukok dvi kortas ir iškviesk čempioną',
    ...
    wrongHint: 'Pradėk nuo paryškintos čempiono kortos — tada pažymėk 2 aukas.',
  ...
  { id: 'upgrade', objective: 'Pakelk čempioną į antrą fazę',
    apply: { goldYou: 1000 },
    dialogue: [say('l4-s05', 'Trys šimtai — antra fazė, dar daugiau — trečia. Pakelk jį.',
      'Už auksą čempionas auga: trys šimtai — antra fazė, dar daugiau — trečia. Kiekviena fazė atrakina naują galią. Spausk ant jo ir pakelk į antrą fazę.')],
  ...
  { id: 'phase-down',
    dialogue: [say('l4-s08', 'Prireikus čempioną gali NULEISTI į žemesnę fazę — meistrų žaidimas.',
      'Įsimink ir tai: prireikus čempioną gali nuleisti į žemesnę fazę — kartais silpnesnė forma turi reikalingesnę galią. Bet tai jau meistrų žaidimas.')],
    complete: { on: 'next' } },
  { id: 'finish', objective: 'Užbaik priešą',
...
const L6_STEPS: LessonStep[] = [
  ...
  { id: 'poison', objective: 'Apnuodyk',
    apply: { goldYou: 1000 },
    dialogue: [say('l6-s04', 'NUODAI ir UGNIS ėda gyvybes kas ėjimą. Lėta mirtis — bet mirtis.',
      'Nuodai ir ugnis. Ėda gyvybes kas ėjimą, po truputį. Lėta mirtis — bet mirtis.')],
...
const L7_STEPS: LessonStep[] = [
  ...
  { id: 'side-deck',
    ...
    highlight: [{ kind: 'anchor', anchor: 'curses-you' }], arrowTo: { kind: 'anchor', anchor: 'curses-you' }, arrowStyle: 'pulse',
    zoom: { kind: 'anchor', anchor: 'curses-you' }, zoomLevel: 2.2, complete: { on: 'next' } },

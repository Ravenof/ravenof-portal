...
// ── Ravenof Digital — Kova prieš AI (PvE) puslapis (main-menu stilius) ────────
    ...
    <div className="max-w-md mx-auto space-y-5">
      <div className="relative" style={{ clipPath: oct(15), background: `rgba(${A},0.5)`, padding: 2.5 }}>
        <div className="px-5 py-6 text-center" style={{ clipPath: oct(14), background: `radial-gradient(120% 90% at 50% 0%, rgba(${A},0.16), rgba(10,8,16,0.97) 60%), linear-gradient(160deg,#15101f,#0a0810)` }}>
          ...
          <h1 className="text-xl font-bold mt-1" style={{ fontFamily: 'var(--rvn-font-display)', color: '#f3ead3', letterSpacing: '0.08em', textShadow: `0 0 12px rgba(${A},0.4)` }}>KOVA PRIEŠ AI</h1>
          <p className="text-[11px] mt-1" style={{ color: 'var(--text-muted)' }}>Treniruokis prieš botą. Sunkumas (😴 lengvas / ⚔ vidutinis / 💀 sunkus) ir priešininkas pasirenkami kitame žingsnyje. Apdovanojimas auksu už pergalę.</p>
        </div>
      </div>
        ...
        <>
          <div className="relative" style={{ clipPath: oct(12), background: `rgba(${A},0.4)`, padding: 2 }}>
            <div className="px-4 py-3" style={{ clipPath: oct(11), background: 'linear-gradient(160deg,#15101f,#0a0810)' }}>
              <label className="text-[10px] font-semibold block mb-1.5 text-center" style={{ color: '#86efac', fontFamily: 'var(--rvn-font-display)', letterSpacing: '0.1em' }}>⚔ TAVO KALADĖ</label>
          ...
          <button onClick={() => { playUiClick(); setOpen(true) }} disabled={!deck}
            ...
            style={{ background: `rgba(${A},0.2)`, border: `1px solid rgba(${A},0.6)`, color: '#86efac', fontFamily: 'var(--rvn-font-display)', letterSpacing: '0.06em' }}>
            ▶ PRADĖTI KOVĄ
          </button>

    ...
    <form action={formAction} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input name="card_number" defaultValue={initialData?.card_number ?? ''} placeholder="pvz. BASE-001"
            style={inputStyle} />
        </div>
        ...
        <div>
          ...
          <input name="name" defaultValue={initialData?.name ?? ''} required placeholder="Kortos pavadinimas"
        ...
        <div>
          ...
          <input name="image_url" defaultValue={initialData?.image_url ?? ''}

    ...
    <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(240,180,41,0.2)', background: 'var(--bg-surface)' }}>
      ...
      <div className="px-4 pb-4 flex flex-col gap-2">
        {[
          ...
          'Ištraukus ×2 arba ×0 - ŽMK ir visa kapinynas (įskaitant ką tik ištrauktą ×2/×0 kortą) iš karto permaišoma. Nauja kaladė suformuojama prieš traukiant kortą kitam taikiniui.',
        ].map((t, i) => (

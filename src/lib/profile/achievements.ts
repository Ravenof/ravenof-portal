...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 19, code: 'ach_19', category: 'tactics', nameLt: 'Pirma reakcija', requirementLt: 'Panaudokite pirmą Reaction kortą', badgeFile: '19-pirma-reakcija.webp', status: 'generated' },
  { id: 20, code: 'ach_20', category: 'tactics', nameLt: 'Grandinės pradžia', requirementLt: 'Suaktyvinkite 2 Reaction vienoje grandinėje', badgeFile: '20-grandines-pradzia.webp', status: 'generated' },
  { id: 21, code: 'ach_21', category: 'tactics', nameLt: 'Reakcijų meistras', requirementLt: 'Panaudokite 50 Reaction', badgeFile: '21-reakciju-meistras.webp', status: 'generated' },
  { id: 22, code: 'ach_22', category: 'tactics', nameLt: 'Kovos šauksmas', requirementLt: 'Suaktyvinkite pirmą Battlecry', badgeFile: '22-kovos-sauksmas.webp', status: 'generated' },
  { id: 23, code: 'ach_23', category: 'tactics', nameLt: 'Šauklių armija', requirementLt: 'Suaktyvinkite 100 Battlecry arba summon efektų', badgeFile: '23-saukliu-armija.webp', status: 'generated' },

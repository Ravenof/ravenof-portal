...
export const IMPACT_FX: Record<ImpactSeverity, ImpactFxSpec> = {
  ...
  DEVASTATING: { sparks: 56, embers: 10, smoke: 6, dust: 0,  debris: 10, rays: 12, flash: 1.4, flashMs: 380, coreR: 140, ringR: 170, ringMs: 520, ring2: true,  shock: true,  coverAlpha: 0.08, speedMul: 1.25, totalMs: 2000, color: '#ff5a2a', hotColor: '#ffe6b0', smokeRgb: '70,60,60' },
  LETHAL:      { sparks: 56, embers: 10, smoke: 6, dust: 0,  debris: 10, rays: 12, flash: 1.4, flashMs: 380, coreR: 140, ringR: 170, ringMs: 520, ring2: true,  shock: true,  coverAlpha: 0.1,  speedMul: 1.25, totalMs: 2000, color: '#ff2d3a', hotColor: '#ffd0d0', smokeRgb: '60,20,24' },
}
